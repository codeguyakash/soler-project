...
const Carousel = ({ images, showSideNavHandler }) => {
  ...
  return (
    <div className="relative top-0 bg-gradient-to-r from-blue-900 to-green-500">
      ...
      >
        <h1
          className="text-5xl md:text-[5.4rem] lg:text-[5.6rem] xl:text-[5.8rem] 2xl:text-[6rem]  leading-[3.4rem] md:leading-[4rem] lg:leading-[5rem] tracking-tighter text-gray-400 font-bold italic animate-fade-right"
          style={{
            backgroundClip: "text",
        ...
        <p className="text-1xl md:text-2xl leading-[1.2rem] md:leading-[2rem] lg:leading-[2rem] tracking-tighterF text-gray-800 py-2 lowercase font-semibold italic animate-fade-right">
